        ...
        >
          <section className="flex-x top-section">
            <div className="flex-y">
              <section className="flex-x lot-street-city">
                <FormInput
              ...
              <section className="flex-x state-zip-condo-unit">
                <Controller
              ...
              <section className="flex-x books-pages-cert-doc">
                <FormInput
                ...
                <FormInput
                  name={dbRef.properties.p_number}
                  labelKey={dbRef.properties.p_number}
                  labelText="Doc #"
                  type="text"
                  isRequired={false}
                  // @ts-ignore
          ...
          <section className="flex-x gap-sm seller-section">
            <FormInput
          ...
          <section className="flex-x gap-sm buyer-section">
            <FormInput
          ...
          <section className="flex-x comp-ref-file-num-section">
            <FormInput
          ...
          <section className="flex-x req-date-close-date-section">
          ...
          <section className="flex-x client-client-file-requester-type-status">
